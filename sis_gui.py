...
class SISApp(tk.Tk):
    def __init__(self):
        ...
        try:
            ...
            pass
        self.style.configure('.', background=dark_bg, foreground=dark_fg, font=('Segoe UI', 10))
        ...
        self.style.configure('TEntry', fieldbackground=light_bg, foreground=dark_fg, insertcolor=dark_fg)
        self.style.configure('TNotebook', background=dark_bg)
        self.style.configure('TNotebook.Tab', background=light_bg, foreground=dark_fg, padding=[12, 4])
        self.style.configure('Treeview', background=light_bg, foreground=dark_fg, fieldbackground=light_bg)
        self.style.configure('Treeview.Heading', background=heading_bg, foreground=dark_fg)
        self.style.map('Treeview', background=[('selected', accent_bg)])
        self.style.configure('Card.TFrame', background=dark_bg)
        self.style.configure('Accent.TButton', background=accent_bg, foreground='white')
    ...
    def _build_login_ui(self):
        ...
        # Info area
        info = ttk.Label(frame, text="Note: Students can edit profile details except SGPA and CGPA.", foreground="white")
    ...
    def _build_profile_tab(self):
        ...
        for i, (label_text, value, disabled) in enumerate(labels):
            ttk.Label(left, text=label_text, foreground="white", font=('Segoe UI', 10, 'bold')).grid(row=i, column=0, sticky='w', pady=6)
        ...
        ttk.Label(right, text="Student Summary", font=('Segoe UI', 16, 'bold'), foreground="white").pack(anchor='w', pady=(0,10))
        summary_frame = tk.Frame(right, bg="#2b2b2b", bd=2, relief='groove', padx=12, pady=12)
        ...
        for text in summary_items:
            lbl = tk.Label(summary_frame, text=text, anchor='w', bg="#2b2b2b", fg="white", font=('Segoe UI', 12))
    ...
    def _build_subjects_tab(self):
        ...
        # small help
        ttk.Label(btn_frame, text="Select a subject row and click Enroll", foreground="white").pack(side='left', padx=(12,0))
    ...
    def _build_enrollments_tab(self):
        ...
        ttk.Label(btn_frame, text="(Withdraw removes the enrollment and related attendance/record.)", foreground="white").pack(side='left', padx=(12,0))
